...
class userCCSignupVC: UIViewController {
    ...
    var CCSignupUser = user()
    
    @objc private func handleNext() {
        
        let vcPass = userInfoSignupVC()
        vcPass.infoSignupUser.carModel = CCSignupUser.carModel
        vcPass.infoSignupUser.carMake = CCSignupUser.carMake
        vcPass.infoSignupUser.carYear = CCSignupUser.carYear
        vcPass.infoSignupUser.carColor = CCSignupUser.carColor
        
        vcPass.infoSignupUser.cardNumber = cardNumberTextField.text!
        vcPass.infoSignupUser.cardName = cardNameTextField.text!
        vcPass.infoSignupUser.cardExpiration = cardExpirationTextField.text!
        vcPass.infoSignupUser.cardCVV = cardCVVTextField.text!
