...
class userInfoSignupVC: UIViewController {
    ...
    var infoSignupUser = user()
    
    @objc private func handleNext() {
        
        let vcPass = userSignupVC()
        ...
        vcPass.profileUser.carModel = infoSignupUser.carModel
        vcPass.profileUser.carMake = infoSignupUser.carMake
        vcPass.profileUser.carYear = infoSignupUser.carYear
        vcPass.profileUser.carColor = infoSignupUser.carColor
